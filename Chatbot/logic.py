...
CLIENT_APP_KEY ="demo44ihRG38UX24DKeFzE15FbbPZfCgz3rh"
...
def book_slot(date, preferred_time, user_info,client_id,location, country_code,timezone):
    print("booking slot:",date, preferred_time,user_info)
    ...
    if preferred_time in available_times:
        ...
        return True, confirm_appointment_with_api(user_info,client_id,location, country_code,timezone)
    else:
...
def confirm_appointment_with_api(user_data, client_id, country_code, timezone):
    ...
    print("confirming user: ",user_data, client_id, country_code,timezone,time_period)
...
def request_call(name, phone, region):
    ...
    payload = {
            "client_id":"demo44ihRG38UX24DKeFzE15FbbPZfCgz3rh",
